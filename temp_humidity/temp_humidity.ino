...
void setup() {
  ...
  server.on("/", handle_OnConnect); // pozivanje funkcije konekcije koja radi
...
void handle_OnConnect() {
  ...
  server.send(200, "text/html", SendHTML(Temperature,Humidity)); // Pozivanje SendHTML funkcije, za renderovanje HTML stranice
}
...
//Definisanje SendHTML funkcije, za renderovanje HTML stranice
...
String SendHTML(float Temperaturestat,float Humiditystat){
  ...
  ptr +="<title>ESP8266 MeteoStanica</title>\n";
  ...
  ptr +="<body>\n";
   ...
   ptr +="<h1>ESP8266 Meteoroloska stanica</h1>\n";
   ptr +="<div class=\"data\">\n";
   ...
   ptr +="</svg>\n";
   ptr +="</div>\n";
   ptr +="<div class=\"side-by-side temperature-text\">Temperatura vazduha</div>\n";
   ...
   ptr +="</svg>\n";
   ptr +="</div>\n";
   ptr +="<div class=\"side-by-side humidity-text\">Vlaznost vazduha</div>\n";
